    ...
    <div class="card-body">
        ...
        <form action="{{ action( [App\Http\Controllers\CursController::class, 'store'] ) }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="custom-select" id="xciclesid" name="xciclesid">
                        ...
                        <option value="{{ $cicle->id }}" {{ ($cicle->id==old('xciclesid')) ? 'selected' : '' }}>{{ $cicle->nom }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-check-input mt-3 ml-1" type="checkbox" value="1" id="xactiu" name="xactiu" {{ (old('xactiu')==1)  ? 'checked' : '' }}>
                </div>
            </div>
