...
@section('pageTitle', 'Edit Municipi | CEP')
...
<div class="card">
    ...
    <div class="card-header">Edit Municipi</div>

    <div class="card-body">

        <form action="{{ action( [App\Http\Controllers\MunicipiController::class, 'update'], ['theobj' => $theobj->id] ) }}" method="POST">
