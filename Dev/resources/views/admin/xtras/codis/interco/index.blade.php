...
@section('pageTitle', 'Codis Interco list | Administració emu061 - Emulador de Sistema d\'Emergències 061')
...
<div class="card">
    ...
    <div class="card-header bg-white">Codis Interco</div>
    ...
    <div class="card-body">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $theobject->codi }}</th>
                    <td>{{ $theobject->nom }}</td>
                    <td>{{ $theobject->soundlike }}</td>
                    {{-- <td class="text-right">

                        <div class="btn-group" role="group">
                            <form class="m-0 p-0" action="{{ action([App\Http\Controllers\CodisIntercoController::class, 'edit'], ['theobj' => $theobject->codi]) }}">
                                @csrf
                        ...
                        <div class="btn-group ml-1" role="group">
                            ...
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#boxModal"
                             ...
                             data-action="{{ action([App\Http\Controllers\CodisIntercoController::class, 'destroy'], ['theobj' => $theobject->codi]) }}"
...
{{-- <a href="{{ action([App\Http\Controllers\CodisIntercoController::class, 'create']) }}"><button id="NewButton" type="button" class="btn btn-secondary">
    <i class="fas fa-plus"></i> Nou Codi Interco</button>
</a> --}}
