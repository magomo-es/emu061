...
@section('pageTitle', 'Codis 3 SEM list | Administració emu061 - Emulador de Sistema d\'Emergències 061')
...
<div class="card">
    ...
    <div class="card-header bg-white">Codis 3 SEM</div>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <div class="btn-group" role="group">
                            <form class="m-0 p-0" action="{{ action([App\Http\Controllers\CodisSEM3Controller::class, 'edit'], ['theobj' => $theobject->codi]) }}">
                                @csrf
                        ...
                        {{-- <div class="btn-group ml-1" role="group">
                            ...
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#boxModal"
                             ...
                             data-action="{{ action([App\Http\Controllers\CodisSEM3Controller::class, 'destroy'], ['theobj' => $theobject->codi]) }}"
...
{{-- <a href="{{ action([App\Http\Controllers\CodisSEM3Controller::class, 'create']) }}"><button id="NewButton" type="button" class="btn btn-secondary">
