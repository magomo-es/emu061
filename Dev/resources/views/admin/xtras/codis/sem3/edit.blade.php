...
@section('pageTitle', 'Edit Codi 3 SEM | CEP')
...
<div class="card">
    ...
    <div class="card-header">Edit Codi 3 SEM</div>

    <div class="card-body">

        <form action="{{ action( [App\Http\Controllers\CodisSEM3Controller::class, 'update'], ['theobj' => $theobj->codi] ) }}" method="POST">
