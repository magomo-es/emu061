...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ action( [App\Http\Controllers\VdsVideosController::class, 'update'], ['theobj' => $theobj->id] ) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row px-3">
                ...
                <div class="custom-file col-5 p-0">
                    <input type="text" class="form-control" value="{{ $theobj->filename }}" readonly>
                </div>
