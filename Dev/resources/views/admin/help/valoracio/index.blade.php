...
@section('pageTitle', 'Valoracions (anglés) list | Administració emu061 - Emulador de Sistema d\'Emergències 061')
...
<div class="card">
    ...
    <div class="card-header bg-white">Valoracions (anglés)</div>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <div class="btn-group" role="group">
                            <form class="m-0 p-0" action="{{ action([App\Http\Controllers\HlpValoracioController::class, 'edit'], ['theobj' => $theobject->codi_valoracio]) }}">
                                @csrf
...
{{-- <a href="{{ action([App\Http\Controllers\HlpValoracioController::class, 'create']) }}"><button id="NewButton" type="button" class="btn btn-secondary">
    <i class="fas fa-plus"></i> Nova Valoracio (anglés)</button>
</a> --}}
