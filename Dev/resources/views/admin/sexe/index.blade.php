...
@section('pageTitle', 'Sexes list | Administració emu061 - Emulador de Sistema d\'Emergències 061')
...
<div class="card">
    ...
    <div class="card-header bg-white">Sexes</div>
    ...
    <div class="card-body">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $theobject->id }}</th>
                    <td>{{ $theobject->sexe }}</td>
                    <td class="text-right">

                        <div class="btn-group" role="group">
                            <form class="m-0 p-0" action="{{ action([App\Http\Controllers\SexeController::class, 'edit'], ['theobj' => $theobject->id]) }}">
                                @csrf
                        ...
                        <div class="btn-group ml-1" role="group">
                            ...
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#boxModal"
                             data-idelement="{{ $theobject->sexe }}"
                             data-action="{{ action([App\Http\Controllers\SexeController::class, 'destroy'], ['theobj' => $theobject->id]) }}"
