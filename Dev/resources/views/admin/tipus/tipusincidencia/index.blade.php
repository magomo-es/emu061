...
@section('pageTitle', 'Tipus Incidencies list | Administració emu061 - Emulador de Sistema d\'Emergències 061')
...
<div class="card">
    ...
    <div class="card-header bg-white">Tipus Incidencies</div>
    ...
    <div class="card-body">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $theobject->id }}</th>
                    <td>{{ $theobject->tipus }}</td>
                    <td>{{ $theobject->video }}</td>
                    <td class="text-right">

                        <div class="btn-group" role="group">
                            <form class="m-0 p-0" action="{{ action([App\Http\Controllers\TipusIncidenciaController::class, 'edit'], ['theobj' => $theobject->id]) }}">
                                @csrf
                        ...
                        <div class="btn-group ml-1" role="group">
                            ...
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#boxModal"
                             data-idelement="{{ $theobject->tipus }}"
                             data-action="{{ action([App\Http\Controllers\TipusIncidenciaController::class, 'destroy'], ['theobj' => $theobject->id]) }}"
...
<a href="{{ action([App\Http\Controllers\TipusIncidenciaController::class, 'create']) }}"><button id="NewButton" type="button" class="btn btn-secondary">
    <i class="fas fa-plus"></i> Nou Tipus Incidencia</button>
</a>
