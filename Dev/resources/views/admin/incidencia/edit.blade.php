    ...
    <div class="card-body">
        ...
        <form action="{{ action( [App\Http\Controllers\IncidenciaController::class, 'update'], ['theobj' => $theobj->id] ) }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-4">
                    <div class="row">
                        <label for="xnumincident" class="col-3 col-form-label"><small>Id Incident</small></label>
                        <div class="col-9">
                ...
                <div class="col-2">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <input type="time" class="form-control" id="xhora" name="xhora" value="{{ $theobj->hora }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-3">
                    <div class="row">
                        <label for="xtelefonalertant" class="col-4 col-form-label"><small>Telefon</small></label>
                        <div class="col-8">
