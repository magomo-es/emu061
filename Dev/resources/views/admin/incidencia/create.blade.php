...
<div class="card">
    ...
    <div class="card-header">Nova Incidencia
        ...
        <button id="addAlertant" type="button" class="btn btn-dark float-right" style="font-size: .7rem;" onclick="openMainVideo()">Videos</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <input type="text" class="form-control" id="telefonalertant" name="telefonalertant" value="{{ old('telefonalertant') }}" pattern="[0-9]{3,9}" minlength="3" maxlength="9" required>
                                </div>
                                <div class="col-4">
