CREATE DATABASE  IF NOT EXISTS `dbs1605720` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `dbs1605720`;
-- MySQL dump 10.13  Distrib 8.0.13, for Win64 (x86_64)
--
-- Host: localhost    Database: dbs1605720
-- ------------------------------------------------------
...
CREATE TABLE `afectats` (
  ...
  `codi_gravetat` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `codi_valoracio` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_afectats_sexes1_idx` (`sexes_id`),
  CONSTRAINT `fk_afectats_sexes1` FOREIGN KEY (`sexes_id`) REFERENCES `sexes` (`id`)
...
INSERT INTO `afectats` VALUES (2,666777888,'MARCI1234569977','Mario Jesus','del Rocio','66',NULL,1,'El mario se cayo y no hablo mas durante el resto del dia',1,'',''),(3,0,NULL,'vbnvb','bvnvbn','51',NULL,2,NULL,NULL,'G00','493.92'),(4,123123,'123','123123','123123','123',NULL,2,NULL,NULL,'G00','305.90'),(5,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,'G00','0'),(6,666666666,'6666666666666666','6666666666','66666666666','666',NULL,2,NULL,NULL,'G00','300.9'),(7,555555555,'5555555555555555','555','555','55',NULL,2,'555',NULL,'G00','251.2'),(9,NULL,NULL,'111','111',NULL,NULL,2,NULL,NULL,'G00','0'),(10,333333333,'3333333333333333','333','333','33',NULL,1,'333',NULL,'G01','300.00'),(11,NULL,NULL,'44','44','44',NULL,2,NULL,NULL,'G00','0');
...
CREATE TABLE `alertants` (
  ...
  CONSTRAINT `fk_alertants_municipis1` FOREIGN KEY (`municipis_id`) REFERENCES `municipis` (`id`),
  CONSTRAINT `fk_alertants_tipus_alertants1` FOREIGN KEY (`tipus_alertants_id`) REFERENCES `tipus_alertants` (`id`)
...
CREATE TABLE `codi_gravetat` (
  `codi` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `codi_interco` (
  `codi` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
  `nom` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `soundlike` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`codi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `codi_sem3` (
  `codi` char(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `nom` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`codi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `codi_sem3` VALUES ('3.0','Aturada Cardiorespiratòria'),('3.01','Alerta telefònica a l’Hospital per ACR'),('3.03','Activació SVAP (Suport Vital Avançat Perllongat)'),('3.08','Aturada Cardiorespiratòria. Èxitus'),('3.1','Trucada telefònica'),('3.10','Retorn a Base'),('3.11','Anul·ació del servei'),('3.12','Es precisa ajut per assistir al malalt. Patologia psiquiàtrica'),('3.13','Fer ús correcte de l’equip de ràdio'),('3.14','Es precisa ajut d’una altra unitat (s’especificarà el tipus)'),('3.15','Relleu de l’equip assitencial'),('3.16','Recurs no operatiu per reposar combustible'),('3.17','Recurs no operatiu per reposar material sanitari'),('3.18','Es precisa ajut de Bombers'),('3.19','Es precisa una Unitat de Transport Sanitari (USVB)'),('3.2','Recurs no operatiu per descans'),('3.20','Resteu atents en espera de noves dades o informació'),('3.21','Donar coordenades de situació o localització de la unitat'),('3.22','Alta mèdica o voluntària'),('3.23','Accident de trànsit'),('3.24','Indigent / Sociopatia'),('3.25','Intoxicació enòlica'),('3.26','Sobredosi per drogues'),('3.27','Politraumàtic, si TCE donar Glasgow'),('3.28','Pacient amb patologia psiquiàtrica. Es troba agitat.'),('3.29','Trauma via pública / domicili'),('3.3','Recurs operatiu'),('3.30','IAM / angor'),('3.31','Intent d’autòlisi'),('3.32','Pacient inconscient'),('3.33','Pacient amb dispnea aguda'),('3.4','Arribada al lloc de l’incident'),('3.40','Silenci a la xarxa, comunitat d’emergència'),('3.5','Informació de la situació o dades de l’afectat'),('3.50','Indiqueu el temps estimat per arribar al lloc de l’incident'),('3.51','Trasllat assistit per metge/infermer. Sortim cap a l’hospital'),('3.52','Trasllat no assistit. Sortim cap a l’hospital'),('3.53','Unitat assistint i operativa per a noves necessitats servei'),('3.6','Finalització del servei. La unitat es troba operativa'),('3.7 G','Es precisa ajut policial - Guàrdia Urbana Local'),('3.7 M',' Es precisa ajut policial - Mossos d’Esquadra'),('3.7 N','Es precisa ajut policial - Cos Nacional de Policia'),('3.70','Es precisa ajut policial URGENT. Situació de risc físic'),('3.8','Èxitus'),('3.9','Recurs no operatiu per accident');
...
CREATE TABLE `codi_valoracio` (
  `codi` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `nom` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`codi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `codi_valoracio` VALUES ('251.2','Hipoglucèmia'),('300.00','Crisi ansietat'),('300.9','Altres transtorns psiquiàtrics'),('305.00','Intoxicació alcohòlica'),('305.90','Intoxicació per drogues (heroïna, cocaïna...)'),('307.9','Agitació psicomotriu'),('379.9','Patologia oftàlmica i annexos'),('388.7','Patologia òtica'),('401.9','Hipertensió arterial'),('427.5','Aturada cardiorespiratòria'),('427.89','Bradicàrdia'),('428,00','Dificultat respiratòria+ANTECEDENTS ICARDIACA'),('436.','Possible AVC'),('458.9','Hipotensió arterial'),('491.21','Dificultat respiratòria+ANTECEDENTS MPOC'),('493.92','Dificultat respiratòria+ANTECEDENTS ASMA'),('578.9','Hemorràgia digestiva'),('641.93','Hemorràgia a l\'embaràs'),('661.33','Inici de part'),('661.93','Dolor/contraccions embaràs'),('723.1','Cervicàlgia'),('724.2','Dolor Lumbar/Dolor Esquena'),('729.5','Dolor a extremitats'),('780.09','Inconsciència/coma'),('780.2','Pèrdua transitòria consciència/lipotímia'),('780.3','Convulsions'),('780.4','Marejos/vertígens'),('780.6','Síndrome febril'),('780.7','Malestar general'),('780.96','Dolor generalitzat/inespecífic'),('782.5','Cianosi'),('784.0','Cefalea'),('784.7','Epistaxi'),('785.0','Taquicàrdia'),('786.00','Dificultat respiratòria'),('786.2','Tos'),('786.30','Hemoptisi'),('786.50','Dolor toràcic'),('787.0','Vòmits'),('788.99','Alteracions genitourinàries'),('789.00','Dolor abdominal'),('790.29','Hiperglucèmia'),('798.1','Possibles èxitus'),('799.1','Aturada respiratòria'),('799.4','Malaltia terminal'),('818.0','Fractura extremitat superior'),('827.0','Fractura extremitat inferior'),('829.0','Polifracturat'),('839.8','Luxació'),('850.0','TCE conscient'),('850.4','TCE insconscient'),('850.5','TCE pèrdua de consciència recuperada'),('879.8','Ferides Penetrants'),('887,00','Amputació EESS'),('897,00','Amputació EEII'),('919.8','Ferides No penetrants/Erosions/Polierosions'),('922.1','Traumatisme toràcic'),('922.2','Traumatisme abdominal'),('924.8','Policontusionat'),('924.9','Contusió'),('934','Obstrucció vies respiratòries'),('949.0','Cremades'),('977.9','Intoxicació medicamentosa'),('987.9','Intoxicació per inhalació de fums'),('989.6','Intoxicació per productes domèstics'),('989.89','Altres intoxicacions'),('991.6','Hipotèrmia'),('992.0','Cop de Calor'),('995.3','Reacció al.lèrgica'),('V02.9','Malaltia de risc: TBC, HIV, VHC...'),('V13.29','Patologia obstètrica/ginecològica mal definida'),('V23.9','Risc d\'avortament'),('V58.9','Sondes/altres accions terapèutiques'),('V60.9','Problema social'),('V62.84','Intent autolisi'),('V65.49','Servei preventiu'),('V65.5','No patologia aparent'),('V71.6','Possible agressió');
...
CREATE TABLE `comarques` (
  ...
  CONSTRAINT `fk_comarques_provincies1` FOREIGN KEY (`provincies_id`) REFERENCES `provincies` (`id`)
...
INSERT INTO `frm_formelements` VALUES (1,'Dades de l\'alertant','En aquest espai has d\'omplir les dades de l\'alertant. Hauràs sol·licitar-li nom, telèfon de contacte, adreça, localitat entre altres opcions possibles.','alertantblock');
...
CREATE TABLE `hlp_simptomes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pregunta` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `translation` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `soundlike` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `hlp_simptomes` VALUES (1,'Té un fort dolor al pit ?','Do you have severe chest pain ?','duː juː hæv sɪˈvɪə ʧɛst peɪn ?'),(2,'Malestar a altres àrees de la part superior de el cos ?','Discomfort in other areas of the upper body ?','dɪsˈkʌmfət ɪn ˈʌðər ˈeərɪəz ɒv ði ˈʌpə ˈbɒdi ?'),(3,'Dificultat per respirar ?','Difficulty breathing ?','ˈdɪfɪkəlti ˈbriːðɪŋ ?'),(4,'Poden consistir en una sensació sobtada de suor freda, nàusees o mareig ?','Can they consist of a sudden feeling of cold sweat, nausea, or dizziness ?','kæn ðeɪ kənˈsɪst ɒv ə ˈsʌdn ˈfiːlɪŋ ɒv kəʊld swɛt, ˈnɔːziə, ɔː ˈdɪzɪnɪs ?'),(5,'Sensació de debilitat o atordiment ?','Feeling weak or lightheaded ?','ˈfiːlɪŋ wiːk ɔː ˈlaɪtˈhɛdɪd ?'),(6,'Tremolar ?','Tremble ?','ˈtrɛmbl ?'),(7,'Suar ?','Sweat ?','swɛt ?'),(8,'Mal de cap o marejos ?','Headache or dizziness ?','ˈhɛdeɪk ɔː ˈdɪzɪnɪs ?'),(9,'Manca de concentració ? / comportament estrany ?','Lack of concentration ? / strange behavior ?','læk ɒv ˌkɒnsənˈtreɪʃən ? / streɪnʤ bɪˈheɪvjə ?'),(10,'Plor o sensació d\'irritabilitat ?','Crying or feeling irritable ?','ˈkraɪɪŋ ɔː ˈfiːlɪŋ ˈɪrɪtəbl ?'),(11,'Fam ?','Hunger ?','ˈhʌŋgə ?'),(12,'Entumiment en llavis i dits de les mans ?','Numbness in lips and fingers ?','ˈnʌmnɪs ɪn lɪps ænd ˈfɪŋgəz ?'),(13,'Palpitacions o elevació de la freqüència cardíaca (taquicàrdia) ?','Palpitations or increased heart rate (tachycardia) ?','ˌpælpɪˈteɪʃənz ɔːr ɪnˈkriːst hɑːt reɪt (ˌtækɪˈkɑːdɪə) ?'),(14,'Sensació d\'ofec, amb respiració ràpida ?','Choking sensation, with rapid breathing ?','ˈʧəʊkɪŋ sɛnˈseɪʃən, wɪð ˈræpɪd ˈbriːðɪŋ ?'),(15,'Opressió al pit ?','Chest tightness ?','ʧɛst ˈtaɪtnɪs ?'),(16,'Por o pànic. Literalment, sentir-se a morir ?','Fear or panic Literally feeling like dying ?','fɪər ɔː ˈpænɪk ˈlɪtərəli ˈfiːlɪŋ laɪk ˈdaɪɪŋ ?'),(17,'Sudoració o calfreds ?','Sweating or chills ?','ˈswɛtɪŋ ɔː ʧɪlz ?'),(18,'Nàusees o molèsties abdominals ?','Nausea or abdominal discomfort ?','ˈnɔːziə ɔːr æbˈdɒmɪnl dɪsˈkʌmfət ?'),(19,'Mareig o fins i tot desmai ?','Dizziness or even fainting ?','ˈdɪzɪnɪs ɔːr ˈiːvən ˈfeɪntɪŋ ?');
...
CREATE TABLE `hlp_valoracio` (
  `codi_valoracio` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `translation` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `soundlike` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `jsontags` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  PRIMARY KEY (`codi_valoracio`),
  KEY `fk_codi_valoracio1_idx` (`codi_valoracio`),
  CONSTRAINT `fk_codi_valoracio1` FOREIGN KEY (`codi_valoracio`) REFERENCES `codi_valoracio` (`codi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hlp_valoracio` VALUES ('251.2','Hypoglycemia','Hypoglycemia',''),('300.00','Anxiety crisis','Anxiety crisis',NULL),('300.9','Other psychiatric disorders','Other psychiatric disorders',''),('305.00','Alcohol intoxication','Alcohol intoxication',''),('305.90','Drug poisoning (heroin, cocaine ...)','Drug poisoning (heroin, cocaine ...)',''),('307.9','Psychomotor agitation','Psychomotor agitation',''),('379.9','Ophthalmic pathology and appendages','Ophthalmic pathology and appendages',''),('388.7','Optical pathology','Optical pathology',''),('401.9','Hypertension','Hypertension',''),('427.5','Cardiorespiratory arrest','Cardiorespiratory arrest',NULL),('427.89','Bradycardia','Bradycardia',''),('428,00','Breathing difficulty + BACKGROUND ICARDIACA','Breathing difficulty + BACKGROUND ICARDIACA',''),('436.','Possible stroke','Possible stroke',''),('458.9','Hypotension','Hypotension',''),('491.21','Respiratory distress + BACKGROUND COPD','Respiratory distress + BACKGROUND COPD',''),('493.92','Respiratory distress + BACKGROUND ASTHMA','Respiratory distress + BACKGROUND ASTHMA',''),('578.9','Digestive hemorrhage','Digestive hemorrhage',''),('641.93','Hemorrhage in pregnancy','Hemorrhage in pregnancy',''),('661.33','Beginning of childbirth','Beginning of childbirth',''),('661.93','Pain / contractions pregnancy','Pain / contractions pregnancy',''),('723.1','Cervical pain','Cervical pain',''),('724.2','Low Back Pain / Back Pain','Low Back Pain / Back Pain',''),('729.5','Pain in limbs','Pain in limbs',''),('780.09','Unconsciousness / coma','Unconsciousness / coma',''),('780.2','Transient loss of consciousness / lipothymia','Transient loss of consciousness / lipothymia',''),('780.3','Convulsions','Convulsions',''),('780.4','Dizziness / vertigo','Dizziness / vertigo',''),('780.6','Febrile syndrome','Febrile syndrome',''),('780.7','General discomfort','General discomfort',''),('780.96','Generalized / nonspecific pain','Generalized / nonspecific pain',''),('782.5','Cyanosis','Cyanosis',''),('784.0','Headache','Headache',''),('784.7','Epistaxis','Epistaxis',''),('785.0','Tachycardia','Tachycardia',''),('786.00','Respiratory difficulty','Respiratory difficulty',''),('786.2','Cough','Cough',''),('786.30','Hemoptysis','Hemoptysis',''),('786.50','Chest pain','Chest pain',''),('787.0','Vomiting','Vomiting',''),('788.99','Genitourinary disorders','Genitourinary disorders',''),('789.00','Abdominal pain','Abdominal pain',''),('790.29','Hyperglycemia','Hyperglycemia',''),('798.1','Possible successes','Possible successes',''),('799.1','Respiratory arrest','Respiratory arrest',''),('799.4','Terminal disease','Terminal disease',''),('818.0','Upper limb fracture','Upper limb fracture',''),('827.0','Lower extremity fracture','Lower extremity fracture',''),('829.0','Polyfractured','Polyfractured',''),('839.8','Dislocation','Dislocation',''),('850.0','TCE conscious','TCE conscious',''),('850.4','Unconscious TCE','Unconscious TCE',''),('850.5','TCE loss of consciousness recovered','TCE loss of consciousness recovered',''),('879.8','Penetrating Wounds','Penetrating Wounds',''),('887,00','Upper-limb amputation','Upper-limb amputation',''),('897,00','Lower-limb amputation','Lower-limb amputation',''),('919.8','Non-penetrating wounds / Erosions / Polyerosions','Non-penetrating wounds / Erosions / Polyerosions',''),('922.1','Chest trauma','Chest trauma',''),('922.2','Abdominal trauma','Abdominal trauma',''),('924.8','Polycontusion','Polycontusion',''),('924.9','Contusion','Contusion',''),('934','Respiratory obstruction','Respiratory obstruction',''),('949.0','Burns','Burns',''),('977.9','Drug poisoning','Drug poisoning',''),('987.9','Inhalation of smoke inhalation','Inhalation of smoke inhalation',''),('989.6','Poisoning by household products','Poisoning by household products',''),('989.89','Other poisonings','Other poisonings',''),('991.6','Hypothermia','Hypothermia',''),('992.0','Heat Stroke','Heat Stroke',''),('995.3','Allergic reaction','Allergic reaction',''),('V02.9','Risk disease: TB, HIV, HCV ...','Risk disease: TB, HIV, HCV ...',''),('V13.29','Poorly defined obstetric / gynecological pathology','Poorly defined obstetric / gynecological pathology',''),('V23.9','Risk of abortion','Risk of abortion',''),('V58.9','Probes / other therapeutic actions','Probes / other therapeutic actions',''),('V60.9','Social problem','Social problem',''),('V62.84','Intent autolysis','Intent autolysis',''),('V65.49','Preventive service','Preventive service',''),('V65.5','No apparent pathology','No apparent pathology',''),('V71.6','Possible aggression','Possible aggression','');
...
CREATE TABLE `hlp_valoracio_has_simptomes` (
  ...
  PRIMARY KEY (`codi_valoracio`,`id_simptoma`),
  KEY `fk_hlp_valoracio_has_simptomes_valoracio1_idx` (`codi_valoracio`),
  KEY `fk_hlp_valoracio_has_simptomes_simptomes1_idx` (`id_simptoma`),
  CONSTRAINT `fk_hlp_valoracio_has_simptomes_simptomes1` FOREIGN KEY (`id_simptoma`) REFERENCES `hlp_simptomes` (`id`),
  CONSTRAINT `fk_hlp_valoracio_has_simptomes_valoracio1` FOREIGN KEY (`codi_valoracio`) REFERENCES `hlp_valoracio` (`codi_valoracio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hlp_valoracio_has_simptomes` VALUES ('300.00',1),('427.5',1),('427.5',2),('300.00',3),('427.5',3),('427.5',4),('251.2',5),('300.00',5),('251.2',6),('300.00',6),('251.2',7),('251.2',8),('300.00',8),('251.2',9),('251.2',10),('251.2',11),('251.2',12),('300.00',13),('300.00',14),('300.00',15),('300.00',16),('300.00',17),('300.00',18),('300.00',19);
...
CREATE TABLE `incidencies` (
  ...
  CONSTRAINT `fk_incidencies_alertants1` FOREIGN KEY (`alertants_id`) REFERENCES `alertants` (`id`),
  CONSTRAINT `fk_incidencies_municipis1` FOREIGN KEY (`municipis_id`) REFERENCES `municipis` (`id`),
  CONSTRAINT `fk_incidencies_tipus_incidents1` FOREIGN KEY (`tipus_incidencies_id`) REFERENCES `tipus_incidencies` (`id`),
  CONSTRAINT `fk_incidencies_usuaris1` FOREIGN KEY (`usuaris_id`) REFERENCES `usuaris` (`id`)
...
INSERT INTO `incidencies` VALUES (1,1111111112,'2021-04-11','17:01:02',666777882,'Plaça Alfons X, 15, 1, 62','L4 Alfons X2','El abuelo se cayo y se daño la pierna2','xx2',4,26,93,7),(3,1,'2021-04-22','18:06:00',932123123,'Ronda del Guinardo 65','L3 Alfons X','Incidencia con persona en la calle','sin metge',3,71,91,6),(5,2,'2021-04-22','21:38:00',123,'sdf','sdf','sdfsdfsdf',NULL,1,74,1,32),(6,2618769,'2021-04-24','23:41:00',999999999,'123123','123123','123123',NULL,4,75,1,3),(8,2260254,'2021-04-25','00:33:00',666666666,'666666666666666666','66666666666666','66666666666666',NULL,4,76,3,3),(10,9631426,'2021-04-25','01:45:00',555555555,'55555','5555','555','555',1,77,1,32),(11,1266274,'2021-04-25','01:56:00',222222222,'222','222','222','222',5,78,2,5),(12,4633781,'2021-04-25','01:58:00',111111111,'111','111','111',NULL,1,79,1,32),(13,4633782,'2021-04-25','01:58:00',111111111,'111','111','111',NULL,1,80,1,32),(14,8016291,'2021-04-25','02:01:00',333333333,'33','33','333',NULL,4,81,3,3),(15,5780922,'2021-04-25','02:04:00',444444444,'44','44','44',NULL,3,82,5,6);
...
CREATE TABLE `incidencies_has_afectats` (
  ...
  CONSTRAINT `fk_incidencies_has_afectats_afectats1` FOREIGN KEY (`afectats_id`) REFERENCES `afectats` (`id`),
  CONSTRAINT `fk_incidencies_has_afectats_incidencies` FOREIGN KEY (`incidencies_id`) REFERENCES `incidencies` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `incidencies_has_recursos` (
  ...
  CONSTRAINT `fk_incidencies_has_recursos_afectats1` FOREIGN KEY (`afectats_id`) REFERENCES `afectats` (`id`),
  CONSTRAINT `fk_incidencies_has_recursos_incidencies1` FOREIGN KEY (`incidencies_id`) REFERENCES `incidencies` (`id`),
  CONSTRAINT `fk_incidencies_has_recursos_recursos1` FOREIGN KEY (`recursos_id`) REFERENCES `recursos` (`id`)
...
INSERT INTO `incidencies_has_recursos` VALUES (8,1,6,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,'6666666666666666',0),(10,1,7,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,'5555',0),(13,1,9,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,0),(15,1,11,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,0);
...
CREATE TABLE `municipis` (
  ...
  CONSTRAINT `fk_municipis_comarques1` FOREIGN KEY (`comarques_id`) REFERENCES `comarques` (`id`)
...
CREATE TABLE `recursos` (
  ...
  CONSTRAINT `fk_recursos_tipus_recursos1` FOREIGN KEY (`tipus_recursos_id`) REFERENCES `tipus_recursos` (`id`)
...
CREATE TABLE `usuaris` (
  ...
  CONSTRAINT `fk_usuaris_recursos1` FOREIGN KEY (`recursos_id`) REFERENCES `recursos` (`id`),
  CONSTRAINT `fk_usuaris_rols1` FOREIGN KEY (`rols_id`) REFERENCES `rols` (`id`)
...
CREATE TABLE `vds_playvideosbycaller` (
  ...
  CONSTRAINT `fk_video1` FOREIGN KEY (`id_video`) REFERENCES `vds_videos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vds_playvideosbycaller` VALUES (1,'Ataque Cardiaco','427.5',1,50,150,NULL);
...
CREATE TABLE `vds_videoevents` (
  ...
  CONSTRAINT `fk_video2` FOREIGN KEY (`id_video`) REFERENCES `vds_videos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vds_videoevents` VALUES (1,'Evento explicacion 10',1,41,5,1,'{\"title\":\"Explicacion a los 41 segundos\",\"content\":\"esto es una explicacion en el segundo 41 y pausa el video por 5 segundos\"}'),(2,'Quiz #1 in 15 segons',1,21,0,2,'{\"title\":\"Quiz #1 in 21 segons\",\"content\":\"Esto es una explicacion en el segundo 21 y pausa el video hasta que se presione cerrar\",\"preguntas\": [\"Crees que esta es la correcta ?\", \"Si no estas seguro puede ser esta ?\",\"Finalmente peudes pensar en que es esta ?\"],\"respuesta\": 0}');
...
INSERT INTO `vds_videos` VALUES (1,'Prueba de Video','Esto es un aprueba de videol','CLIP+1+Procediment+RCP+complet.mp4');
...
-- Dump completed on 2021-05-17 13:09:24
