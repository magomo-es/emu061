...
LOCK TABLES `FormElements` WRITE;
/*!40000 ALTER TABLE `FormElements` DISABLE KEYS */;
/*!40000 ALTER TABLE `FormElements` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `PlayVideoByCaller`
--

DROP TABLE IF EXISTS `PlayVideoByCaller`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `PlayVideoByCaller` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(250) DEFAULT NULL,
  `id_formelement` int(10) unsigned NOT NULL,
  `id_video` int(10) unsigned NOT NULL,
  `start` int(10) unsigned DEFAULT NULL,
  `ends` int(10) unsigned DEFAULT NULL,
  `playevent` tinyint(3) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_formelement1` (`id_formelement`),
  KEY `fk_video1` (`id_video`),
...
--
-- Dumping data for table `PlayVideoByCaller`
--

LOCK TABLES `PlayVideoByCaller` WRITE;
/*!40000 ALTER TABLE `PlayVideoByCaller` DISABLE KEYS */;
/*!40000 ALTER TABLE `PlayVideoByCaller` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `VideoEvents`
--
...
CREATE TABLE `VideoEvents` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_video2` (`id_video`),
  CONSTRAINT `fk_video2` FOREIGN KEY (`id_video`) REFERENCES `Videos` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `VideoEvents`
--

LOCK TABLES `VideoEvents` WRITE;
/*!40000 ALTER TABLE `VideoEvents` DISABLE KEYS */;
/*!40000 ALTER TABLE `VideoEvents` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-04-09  8:15:24
