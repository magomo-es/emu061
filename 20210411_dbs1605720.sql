...
CREATE TABLE `hlp_simptomes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pregunta` varchar(250) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `hlp_valoracio` (
  ...
  CONSTRAINT `fk_codi_valoracio1` FOREIGN KEY (`codi_valoracio`) REFERENCES `codi_valoracio` (`codi`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hlp_valoracio` VALUES ('307.9','Psychomotor agitation','Psychomotor agitation',''),('788.99','Genitourinary disorders','Genitourinary disorders',''),('989.89','Other poisonings','Other poisonings',''),('300.9','Other psychiatric disorders','Other psychiatric disorders',''),('897,00','Lower-limb amputation','Lower-limb amputation',''),('887,00','Upper-limb amputation','Upper-limb amputation',''),('427.5','Cardiorespiratory arrest','Cardiorespiratory arrest',''),('799.1','Respiratory arrest','Respiratory arrest',''),('427.89','Bradycardia','Bradycardia',''),('784.0','Headache','Headache',''),('723.1','Cervical pain','Cervical pain',''),('782.5','Cyanosis','Cyanosis',''),('924.9','Contusion','Contusion',''),('780.3','Convulsions','Convulsions',''),('992.0','Heat Stroke','Heat Stroke',''),('949.0','Burns','Burns',''),('300.00','Anxiety crisis','Anxiety crisis',''),('786.00','Respiratory difficulty','Respiratory difficulty',''),('493.92','Respiratory distress + BACKGROUND ASTHMA','Respiratory distress + BACKGROUND ASTHMA',''),('428,00','Breathing difficulty + BACKGROUND ICARDIACA','Breathing difficulty + BACKGROUND ICARDIACA',''),('491.21','Respiratory distress + BACKGROUND COPD','Respiratory distress + BACKGROUND COPD',''),('729.5','Pain in limbs','Pain in limbs',''),('789.00','Abdominal pain','Abdominal pain',''),('780.96','Generalized / nonspecific pain','Generalized / nonspecific pain',''),('724.2','Low Back Pain / Back Pain','Low Back Pain / Back Pain',''),('786.50','Chest pain','Chest pain',''),('661.93','Pain / contractions pregnancy','Pain / contractions pregnancy',''),('784.7','Epistaxis','Epistaxis',''),('919.8','Non-penetrating wounds / Erosions / Polyerosions','Non-penetrating wounds / Erosions / Polyerosions',''),('879.8','Penetrating Wounds','Penetrating Wounds',''),('827.0','Lower extremity fracture','Lower extremity fracture',''),('818.0','Upper limb fracture','Upper limb fracture',''),('786.30','Hemoptysis','Hemoptysis',''),('641.93','Hemorrhage in pregnancy','Hemorrhage in pregnancy',''),('578.9','Digestive hemorrhage','Digestive hemorrhage',''),('790.29','Hyperglycemia','Hyperglycemia',''),('401.9','Hypertension','Hypertension',''),('251.2','Hypoglycemia','Hypoglycemia',''),('458.9','Hypotension','Hypotension',''),('991.6','Hypothermia','Hypothermia',''),('780.09','Unconsciousness / coma','Unconsciousness / coma',''),('661.33','Beginning of childbirth','Beginning of childbirth',''),('V62.84','Intent autolysis','Intent autolysis',''),('305.00','Alcohol intoxication','Alcohol intoxication',''),('977.9','Drug poisoning','Drug poisoning',''),('305.90','Drug poisoning (heroin, cocaine ...)','Drug poisoning (heroin, cocaine ...)',''),('987.9','Inhalation of smoke inhalation','Inhalation of smoke inhalation',''),('989.6','Poisoning by household products','Poisoning by household products',''),('839.8','Dislocation','Dislocation',''),('V02.9','Risk disease: TB, HIV, HCV ...','Risk disease: TB, HIV, HCV ...',''),('799.4','Terminal disease','Terminal disease',''),('780.7','General discomfort','General discomfort',''),('780.4','Dizziness / vertigo','Dizziness / vertigo',''),('V65.5','No apparent pathology','No apparent pathology',''),('934','Respiratory obstruction','Respiratory obstruction',''),('V13.29','Poorly defined obstetric / gynecological pathology','Poorly defined obstetric / gynecological pathology',''),('379.9','Ophthalmic pathology and appendages','Ophthalmic pathology and appendages',''),('388.7','Optical pathology','Optical pathology',''),('780.2','Transient loss of consciousness / lipothymia','Transient loss of consciousness / lipothymia',''),('924.8','Polycontusion','Polycontusion',''),('829.0','Polyfractured','Polyfractured',''),('V71.6','Possible aggression','Possible aggression',''),('436.','Possible stroke','Possible stroke',''),('798.1','Possible successes','Possible successes',''),('V60.9','Social problem','Social problem',''),('995.3','Allergic reaction','Allergic reaction',''),('V23.9','Risk of abortion','Risk of abortion',''),('V65.49','Preventive service','Preventive service',''),('780.6','Febrile syndrome','Febrile syndrome',''),('V58.9','Probes / other therapeutic actions','Probes / other therapeutic actions',''),('785.0','Tachycardia','Tachycardia',''),('850.0','TCE conscious','TCE conscious',''),('850.4','Unconscious TCE','Unconscious TCE',''),('850.5','TCE loss of consciousness recovered','TCE loss of consciousness recovered',''),('786.2','Cough','Cough',''),('922.2','Abdominal trauma','Abdominal trauma',''),('922.1','Chest trauma','Chest trauma',''),('787.0','Vomiting','Vomiting','');
...
CREATE TABLE `hlp_valoracio_has_simptomes` (
  ...
  CONSTRAINT `fk_hlp_valoracio_has_simptomes_valoracio1` FOREIGN KEY (`codi_valoracio`) REFERENCES `hlp_valoracio` (`codi_valoracio`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-04-11  0:01:51
