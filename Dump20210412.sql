...
CREATE TABLE `afectats` (
  ...
  `codi_gravetat` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `codi_valoracio` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `codi_gravetat` (
  `codi` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `codi_interco` (
  ...
  `nom` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `soundlike` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`codi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `codi_sem3` (
  `codi` char(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nom` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`codi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `codi_valoracio` (
  `codi` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nom` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`codi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `hlp_simptomes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pregunta` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `translation` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `soundlike` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `hlp_simptomes` VALUES (1,'Té un fort dolor al pit ?','Do you have severe chest pain?','Do you have severe chest pain?'),(2,'Malestar a altres àrees de la part superior de el cos ?','Discomfort in other areas of the upper body ?','Discomfort in other areas of the upper body ?'),(3,'Dificultat per respirar ?','Difficulty breathing ?','Difficulty breathing ?'),(4,'Poden consistir en una sensació sobtada de suor freda, nàusees o mareig ?','Can they consist of a sudden feeling of cold sweat, nausea, or dizziness ?','Can they consist of a sudden feeling of cold sweat, nausea, or dizziness ?');
...
CREATE TABLE `hlp_valoracio` (
  `codi_valoracio` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `translation` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `soundlike` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jsontags` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
INSERT INTO `hlp_valoracio_has_simptomes` VALUES ('427.5',1),('427.5',2),('427.5',3);
...
INSERT INTO `vds_videoevents` VALUES (1,'Evento explicacion 10',1,10,20,1,'{\r\n\"title\":\"Explicacion a los 10 segundos\",\r\n\"content\":\"esto es una explicacion en el segundo 10 y pausa el video por 20 segundos\"\r\n}'),(2,'Quiz #1 in 15 segons',1,53,15,2,'{\r\n\"title\":\"Quiz #1 in 15 segons\",\r\n\"content\":\"esto es una explicacion en el segundo 10 y pausa el video por 20 segundos\",\r\n\"preguntas\": [\"Crees que esta es la correcta ?\", \"Si no estas seguto puede ser esta ?\",\"Finalmente peudes pensar en que es esta ?\"],\r\n\"respuesta\": 0\r\n}');
...
INSERT INTO `vds_videos` VALUES (1,'Prueba de Video','Esto es un aprueba de videol','CLIP 1 Procediment RCP complet.MOV');
...
-- Dump completed on 2021-04-12 10:15:22
